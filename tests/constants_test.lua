...
Test.case("hide-out-of-combat, hide-outside-raid, and manual hide all default to off", function()
    Test.equal(_G.TurmoilsAddon_CONSTANTS.defaults.global.hideOutOfCombat, false)
    Test.equal(_G.TurmoilsAddon_CONSTANTS.defaults.global.hideOutsideRaid, false)
    Test.equal(_G.TurmoilsAddon_CONSTANTS.defaults.global.manuallyHidden, false)
end)
